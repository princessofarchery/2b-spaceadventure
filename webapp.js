...
function updateScene(s) {
	 switch(s) {
		...
		case "s1":
			...
			//change btn2
			document.getElementById("btn2").innerHTML = "Serona";
			document.getElementById("btn2").addEventListener("click", function() {
				updateScene("s5");
			});
			break;
		...
		case"s5":
			...
			break;
		case"s6":
			document.getElementById("storyline").innerHTML=" <p>If you choose to sleep</p> Harold: Ok now it is the morning currently unaware of the time.</p><Base ?>:";
			break;
	}
 }